...
///_____________________________________________________________________________________________________________________________________________________________________________
 ...
 void choixdunombre(int *ptrNombre) ///lorsque vous appelez choixdunombre, vous permettez à cette fonction de modifier la valeur de la variable qu'elle prends en compte (pointeur).
    ...
    {
     do {
        scanf("%d", ptrNombre); ///scanf lis le nombre que ptrNombre doit envoyer à la variable pris en compte dans la fonction choixdunombre ! ici il l'envoie au "pointeur" qui fait le relai hors de la
